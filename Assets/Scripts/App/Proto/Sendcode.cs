    ...
    static SendcodeReflection() {
        byte[] descriptorData = global::System.Convert.FromBase64String(
            string.Concat(
                ...
                "IAEoCRIOCgZtb2JpbGUYAyABKAkSDgoGcmVzZW5kGAQgASgJEhMKC2xhc3RD",
                "aGFubmVsGAUgASgFEgwKBGV4dDEYBiABKAkSDAoEZXh0MhgHIAEoCRIMCgRl",
                "eHQzGAggASgJEgwKBGV4dDQYCSABKAkSDAoEZXh0NRgKIAEoCUInCiVjb20u",
                "anhqeGdvLmFwaWdhdGV3YXkuZG9tYWluLmh0dHAucmVxYgZwcm90bzM="));
...
public sealed partial class SendLoginVerificationCodeReq : pb::IMessage<SendLoginVerificationCodeReq> {
    ...
    private string resend_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public string Resend {
        get { return resend_; }
        set {
            resend_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
        }
    }
    ...
    public override int GetHashCode() {
        ...
        if (Resend.Length != 0) hash ^= Resend.GetHashCode();
    ...
    public int CalculateSize() {
        ...
        if (Resend.Length != 0) {
            size += 1 + pb::CodedOutputStream.ComputeStringSize(Resend);
        }
        if (LastChannel != 0) {
