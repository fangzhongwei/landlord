...
namespace Assets.Scripts.App.Helper
{
    public class CardHelper
    {
        ...
        public TypeWithPoints JudgeType(List<int> points)
        {
            Debug.Log("JudgeType, points:" + points);
            //plain list
            for (int i = 0; i < points.Count; i++)
            {
                points[i] = points[i] % 100;
            }
            Debug.Log("Plain points:" + points);
            Sort(points);
            Debug.Log("Points after sort:" + points);
        ...
        private void Sort(List<int> points)
        {
